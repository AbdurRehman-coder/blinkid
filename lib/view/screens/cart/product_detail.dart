...
class _ProductDetailState extends State<ProductDetail> {
  List<String> productSize = ["Small", "Medium", "Large", "X-Large"];
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                      ...
                      children: [
                        Row(
                          children: List.generate(
                              5,
                              (i) => Icon(
                                    i == 4 ? Icons.star_half_outlined : Icons.star_rate,
                  ...
                  Text(
                    "Diaper bag is spacious enough to accomodate a number of your baby supplies as it has multiple pockets. You can put important baby care items in an organized fashion so that you can fetch them effortlessly when needed, without having to turn the bag upside down.",
                    style: AppTextStyle.gilroyLight
